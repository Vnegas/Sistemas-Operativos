...
// The following class define a Barrier, each barrier will suspend "count" threads
// Once the required threads arrive at barrier point, they can continue
class Barrier {
   public:
